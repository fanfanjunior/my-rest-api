    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Welcome to Api FannnBOT - an awesome REST API!</h3>
            <p>
...
If you have any problem, please contact via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=6287753703416">WhatsApp</a></span></span>
      ...
      let mailOptions = {
        from: '"FannnBOT" <no-reply@gmail.com>',
        to: email,
        subject: `Verify Email - Api FannnBOT`,
        html: inboxGmail,
      };
